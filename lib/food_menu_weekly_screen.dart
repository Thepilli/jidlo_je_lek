...
class FoodMenuWeeklyScreen extends StatefulWidget {
  @override
  State<FoodMenuWeeklyScreen> createState() => _FoodMenuWeeklyScreenState();
}

class _FoodMenuWeeklyScreenState extends State<FoodMenuWeeklyScreen> {
  int weekNumber = 0;
  int cycleNumber = 0;
