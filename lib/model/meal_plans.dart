...
List<Meal> mealList = [
  Meal(
    ...
    mealImageAssets: [
      MealImage(
        ...
        mealImageDescription: "Normální porce: slaná",
      ),
      MealImage(
        mealImagePath:
            "assets/images/meal_plans/breakfast/breakfast_normal_02.jpg",
        mealImageDescription: "Normální porce: sladká",
      ),
      MealImage(
        mealImagePath:
            "assets/images/meal_plans/breakfast/breakfast_large_01.jpg",
        mealImageDescription: "Zvýšená porce: slaná",
      ),
    ],
    mealTime: "8:00",
  ),
  Meal(
    ...
    mealImageAssets: [
      MealImage(
        ...
        mealImageDescription: "Normální porce: ovoce",
      ),
      MealImage(
      ...
      MealImage(
        ...
        mealImageDescription: "Zvýšená porce: sladká",
      ),
    ],
    mealTime: "10:00",
  ),
  ...
  Meal(
    ...
    mealImageAssets: [
      MealImage(
        mealImagePath:
            "assets/images/meal_plans/model_01/breakfast_model_01.jpg",
  ...
  Meal(
    ...
    mealImageAssets: [
      MealImage(
        mealImagePath:
            "assets/images/meal_plans/model_02/breakfast_model_02.jpg",
        mealImageDescription: "Snídaně",
      ),
      MealImage(
  ...
  Meal(
    ...
    mealImageAssets: [
      MealImage(
        mealImagePath:
            "assets/images/meal_plans/model_03/breakfast_model_03.jpg",
        mealImageDescription: "Snídaně",
      ),
      MealImage(
