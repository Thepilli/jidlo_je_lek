...
//       body: ListView(
//         children: [
//           buildAppCard('Aplikace Nepanikař', 'assets/icons/help_nepanikar.png', 'assets/htmls/1_LF_UK_a_VFN_oddeleni.html'),
//           buildCard('Lůžkové specializované oddělení', 'assets/icons/help_oddeleni.png',
//               'assets/htmls/1_LF_UK_a_VFN_oddeleni.html'),
//           buildCard('Denní stacionář', 'assets/icons/help_stacionar.png', 'assets/htmls/1_LF_UK_a_VFN_stacionar.html'),
//           buildCard('Specializovaná ambulantní péče', 'assets/icons/help_ambulance.png',
//               'assets/htmls/1_LF_UK_a_VFN_ambulance.html'),
//           buildCard('E-clinic', 'assets/icons/help_e_clinic.png', 'assets/htmls/e_clinic.html'),
//         ],
//       ),
//     );
//   }
